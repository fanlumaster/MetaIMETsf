...
// {4B62B54B-F828-43B5-9095-A96DF9CBDF38}
    extern const GUID MetasequoiaIMEGuidImeModePreserveKey = {0x4b62b54b, 0xf828, 0x43b5, {0x90, 0x95, 0xa9, 0x6d, 0xf9, 0xcb, 0xdf, 0x38}
    };

// {5A08D6C4-4563-4E46-8DDB-65E75C4E73A3}
    extern const GUID MetasequoiaIMEGuidDoubleSingleBytePreserveKey = {0x5a08d6c4, 0x4563, 0x4e46, {0x8d, 0xdb, 0x65, 0xe7, 0x5c, 0x4e, 0x73, 0xa3}
    };

// {175F062E-B961-4AED-A3DF-59F78A02862D}
    extern const GUID MetasequoiaIMEGuidPunctuationPreserveKey = {0x175f062e, 0xb961, 0x4aed, {0xa3, 0xdf, 0x59, 0xf7, 0x8a, 0x2, 0x86, 0x2d}
    };
...
// {101011C5-CF72-4F0C-A515-153019593F10}
    extern const GUID MetasequoiaIMEGuidCompartmentDoubleSingleByte = {0x101011c5, 0xcf72, 0x4f0c, {0xa5, 0x15, 0x15, 0x30, 0x19, 0x59, 0x3f, 0x10}
    };

// {DD321BCC-A7F8-4561-9B61-9B3508C9BA97}
    extern const GUID MetasequoiaIMEGuidCompartmentPunctuation = {0xdd321bcc, 0xa7f8, 0x4561, {0x9b, 0x61, 0x9b, 0x35, 0x8, 0xc9, 0xba, 0x97}
    };
...
// {89BE500C-9462-4070-9DB0-B467BB051327}
    extern const GUID MetasequoiaIMEGuidLangBarIMEMode = {0x89be500c, 0x9462, 0x4070, {0x9d, 0xb0, 0xb4, 0x67, 0xbb, 0x5, 0x13, 0x27}
    };

// {6A11D9DE-46DB-455B-A257-2EB615746BF4}
    extern const GUID MetasequoiaIMEGuidLangBarDoubleSingleByte = {0x6a11d9de, 0x46db, 0x455b, {0xa2, 0x57, 0x2e, 0xb6, 0x15, 0x74, 0x6b, 0xf4}
    };

// {F29C731A-A51E-49FB-8A3C-EE51752912E2}
    extern const GUID MetasequoiaIMEGuidLangBarPunctuation = {0xf29c731a, 0xa51e, 0x49fb, {0x8a, 0x3c, 0xee, 0x51, 0x75, 0x29, 0x12, 0xe2}
    };

// {4C802E2C-8140-4436-A5E5-F7C544EBC9CD}
    extern const GUID MetasequoiaIMEGuidDisplayAttributeInput = {0x4c802e2c, 0x8140, 0x4436, {0xa5, 0xe5, 0xf7, 0xc5, 0x44, 0xeb, 0xc9, 0xcd}
    };

// {9A1CC683-F2A7-4701-9C6E-2DA69A5CD474}
    extern const GUID MetasequoiaIMEGuidDisplayAttributeConverted = {0x9a1cc683, 0xf2a7, 0x4701, {0x9c, 0x6e, 0x2d, 0xa6, 0x9a, 0x5c, 0xd4, 0x74}
    };
...
// {84B0749F-8DE7-4732-907A-3BCB150A01A8}
    extern const GUID MetasequoiaIMEGuidCandUIElement = {0x84b0749f, 0x8de7, 0x4732, {0x90, 0x7a, 0x3b, 0xcb, 0x15, 0xa, 0x1, 0xa8}
    };
...
// ---------------------------------------------------------------------
    extern const WCHAR FullWidthCharTable[] = {0x3000, // Full width space
                                               0xFF01, // ！
                                               0xFF02, // ＂
                                               0xFF03, // ＃
                                               0xFF04, // ＄
